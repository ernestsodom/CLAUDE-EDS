...
- **Comparador de cumplimiento**: licitación vs avances → tabla requerimiento a requerimiento (estado, evidencia, página, comentario IA, riesgo, prioridad), porcentajes y **semáforo**. Además diferencias entre dos licitaciones/propuestas/contratos/versiones.
